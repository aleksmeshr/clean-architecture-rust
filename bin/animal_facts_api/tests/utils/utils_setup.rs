...
use animal_facts_repositories::http::models::{CatFactApiModel, CatFactsApiModel};
...
pub fn spawn_app(db_name: &str) -> String {
    ...
    let server = animal_facts_api::serve(listener, db_name).expect("Failed to bind address");
