use crate::presentation::product::{product_dto::ProductPayload, product_http_mapper};
...
async fn get_product_by_id(
    ...
    product
        ...
        .map(|fact| HttpResponse::Ok().json(fact.into_iter().map(product_http_mapper::to_api)))
}
