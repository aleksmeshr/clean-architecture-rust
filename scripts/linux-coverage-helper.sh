...
# This file is a Linux-friendly coverage solution based on the approach documented here:
# https://doc.rust-lang.org/nightly/unstable-book/compiler-flags/instrument-coverage.html
# Origin https://github.com/cooperwalbrun/rust-template/blob/master/scripts/linux-coverage-helper.sh
