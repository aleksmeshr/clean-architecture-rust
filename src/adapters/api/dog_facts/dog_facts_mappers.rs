use crate::adapters::{
    api::dog_facts::dog_facts_payloads::DogFactPayload,
    api::dog_facts::dog_facts_presenters::DogFactPresenter,
};
...
impl ApiMapper<DogFactEntity, DogFactPresenter, DogFactPayload> for DogFactPresenterMapper {
    fn to_api(entity: DogFactEntity) -> DogFactPresenter {
        DogFactPresenter { fact_id: entity.fact_id, txt: entity.fact }
    }
